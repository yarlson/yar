...
fn listen(host str, port i32) !i64 {
...
fn listener_addr(listener i64) !Addr {
    panic("net.listener_addr intrinsic")
}

fn close_listener(listener i64) !void {
...
fn read(conn i64, max_bytes i32) !str {
    panic("net.read intrinsic")
}

fn write(conn i64, data str) !i32 {
    panic("net.write intrinsic")
}

fn close(conn i64) !void {
...
fn remote_addr(conn i64) !Addr {
    panic("net.remote_addr intrinsic")
}

fn set_read_deadline(conn i64, millis i32) !void {

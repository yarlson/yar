...
- `internal/stdlib` embeds the standard library written in yar (including `strings`, `utf8`, `conv`, `path`, `fs`, `process`, `env`, and `stdio`) and provides lookup functions for the package loader.

...
- Embedded stdlib packages currently include `strings`, `utf8`, `conv`, `sort`, `path`, `fs`, `process`, `env`, and `stdio`.
- `sort` provides in-place ascending helpers: `strings([]str)`, `i32s([]i32)`, and `i64s([]i64)`.

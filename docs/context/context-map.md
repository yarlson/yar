...
- [summary.md](summary.md) — Project-wide view of the compiler, package model,
  runtime boundary, and implemented capabilities.
- [terminology.md](terminology.md) — Stable terms used by the compiler, lowered
  program, stdlib, and runtime contract.
- [practices.md](practices.md) — Enforced invariants and recurring
...
- [flows/source-to-native.md](flows/source-to-native.md) — Command-level path
  from source file to diagnostics, IR, binary, and execution.
